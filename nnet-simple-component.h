...
class ClipGradientComponent: public Component {
 public:
  ClipGradientComponent(int32 dim, BaseFloat clipping_threshold,
                        bool norm_based_clipping, bool l1_norm_based_clipping,
                        int32 num_clipped,
                        int32 count) {
    Init(dim, clipping_threshold, norm_based_clipping, l1_norm_based_clipping, num_clipped, count);}

  ClipGradientComponent(): dim_(0), clipping_threshold_(-1),
    norm_based_clipping_(false), l1_norm_based_clipping_(false), 
 ...
 private:
  ...
  bool norm_based_clipping_;  // if true the max-row-norm will be clipped
                              ...
                              // done
  bool l1_norm_based_clipping_; // if true the max-row-l1-norm will be clipped

...
/// If the matrix has 8 rows or fewer or format=2, we simply store all values as
/// uint16.
...
class CompressedMatrix {
 public:
  ...
  CompressedMatrix(const MatrixBase<Real> &mat, int32 format = 0): data_(NULL) { CopyFromMat(mat, format); }

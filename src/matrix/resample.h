...
class ArbitraryResample {
 public:
  ArbitraryResample(int32 num_samples_in,
                    ...
                    int32 num_zeros);
  ArbitraryResample(const ArbitraryResample &other): num_samples_in_(other.num_samples_in_),
    samp_rate_in_(other.samp_rate_in_), 
    filter_cutoff_(other.filter_cutoff_),
    num_zeros_(other.num_zeros_), 

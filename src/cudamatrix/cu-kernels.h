...
inline void cuda_mul_col_groups_by_vec(dim3 Gr, dim3 Bl, double *mat,
                                       const double *scale, MatrixDim d,
                                       int group_size) {
  cudaD_mul_col_groups_by_vec(Gr, Bl, mat, scale, d, group_size);
}
inline void cuda_mul_col_groups_by_vec(dim3 Gr, dim3 Bl, float *mat,
                                       const float *scale, MatrixDim d,
                                       int group_size) {
  cudaF_mul_col_groups_by_vec(Gr, Bl, mat, scale, d, group_size);
}

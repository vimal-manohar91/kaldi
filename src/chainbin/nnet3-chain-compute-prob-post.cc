...
int main(int argc, char *argv[]) {
  try {
    ...
    const char *usage =
        ...
        "e.g. nnet3-chain-get-egs-post | nnet3-merge-egs.\n"
        "\n"
        "Usage:  nnet3-chain-compute-prob-post [options] <raw-nnet3-model-in> <denominator-fst> <training-examples-in>\n"
        "e.g.: nnet3-chain-compute-prob-post 0.mdl den.fst ark:valid.egs\n";

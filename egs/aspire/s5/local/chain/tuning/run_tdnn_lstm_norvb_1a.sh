...
lat_dir=exp/chain${chain_affix}/tri5a_${train_set}_sp_lats  # training lattices directory
dir=exp/chain${chain_affix}/tdnn_lstm${tdnn_affix}_sp
train_data_dir=data/${train_set}_sp_hires
train_ivector_dir=exp/nnet3${nnet3_affix}/ivectors_${train_set}_sp
...
local/nnet3/run_ivector_common_norvb.sh --stage $stage \
                                  --speed-perturb true \
                                  --train-set $train_set \

...
utils/combine_data.sh --extra-files "irm_targets.scp speech_feat.scp deriv_weights.scp deriv_weights_manual_seg.scp music_labels.scp" \
...
local/segmentation/run_train_stats_sad_music.sh \
  --train-data-dir data/fisher_train_100k_whole_all_corrupted_sp_hires_bp \
  --snr-scp data/fisher_train_100k_whole_all_corrupted_sp_hires_bp/irm_targets.scp \
  ...
  --deriv-weights-for-irm-scp data/fisher_train_100k_whole_all_corrupted_sp_hires_bp/deriv_weights_manual_seg.scp \

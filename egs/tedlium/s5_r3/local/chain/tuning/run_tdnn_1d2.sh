...
train_stage=-10
tree_affix=_7000  # affix for tree directory, e.g. "a" or "b", in case we change the configuration.
tdnn_affix=_1d2  #affix for TDNNF directory, e.g. "a" or "b", in case we change the configuration.
...
if [ $stage -le 17 ]; then
  ...
  affine_opts="l2-regularize=0.004 dropout-proportion=0.0 dropout-per-dim-continuous=true"
  tdnnf_opts="l2-regularize=0.004 dropout-proportion=0.0 bypass-scale=0.66"
  linear_opts="l2-regularize=0.008 orthonormal-constraint=-1.0"
  prefinal_opts="l2-regularize=0.004"

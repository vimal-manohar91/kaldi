...
if [ $stage -le 12 ]; then
  ...
  tdnnf_opts="l2-regularize=0.008 dropout-proportion=0.0 bypass-scale=0.66 use-layer-norm=true"
  linear_opts="l2-regularize=0.008 orthonormal-constraint=-1.0"
  prefinal_opts="l2-regularize=0.008 use-layer-norm=true"
  ...
  relu-renorm-dropout-layer name=tdnn1 $affine_opts dim=$hidden_dim

...
if [ $stage -le 1 ]; then
  steps/online/nnet2/extract_ivectors_online.sh --cmd queue.pl --nj 1600 \
    data/how2_unsup_1a_seg exp/nnet3_cleaned/extractor exp/nnet3_cleaned/ivectors_how2_unsup_1a_seg
fi
...
if [ $stage -le 2 ]; then
  steps/nnet3/decode_semisup.sh \
    ...
    --online-ivector-dir exp/nnet3_cleaned/ivectors_how2_unsup_1a_seg \
    exp/chain_cleaned/tdnn_1c2_sp_bi/graph data/how2_unsup_1a_seg \
    exp/chain_cleaned/tdnn_1c2_sp_bi/decode_how2_unsup_1a_seg 
fi

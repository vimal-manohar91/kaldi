...
# This script is similar to run_tdnn_lstm_semisup_mx6_1c.sh, but uses
# separate output layer for unsupervised data (Mixer 6) 
# in addition to using separate denominator FST.

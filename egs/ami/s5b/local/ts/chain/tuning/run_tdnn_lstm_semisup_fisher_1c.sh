...
unsup_src_data_dir=data/train_fisher_300k_1200k_16kHz

# lang for decoding unsupervised data
unsup_graph_affix=_fisher_300k
unsup_lang=data/lang_fisher_300k_test
...
tdnn_affix=_1c
chain_affix=_ts_ami_fisher
nnet3_affix=_ts_ami_fisher

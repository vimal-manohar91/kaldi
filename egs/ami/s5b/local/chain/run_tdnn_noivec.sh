...
# This is just for creating hires features. The ivectors are not used in this 
# recipe.
...
if $use_ihm_ali; then
  ...
  dir=exp/$mic/chain${nnet3_affix}/tdnn_noivec${tdnn_affix}_sp_bi_ihmali
  ...
  dir=exp/$mic/chain${nnet3_affix}/tdnn_noivec${tdnn_affix}_sp_bi
fi

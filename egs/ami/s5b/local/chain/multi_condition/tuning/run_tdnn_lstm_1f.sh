...
local/nnet3/multi_condition/run_ivector_common_extra.sh --stage $stage \
                                  --mic $mic \
                                  --nj $nj \
                                  --train-set $train_set \
                                  ...
                                  --extra-ivector-data-dir "$extra_ivector_data_dir"
...
if [ $stage -le 15 ]; then
  ...
  lstm_opts="l2-regularize=0.00125 decay-time=20 dropout-proportion=0.0"
...
if [ $stage -le 16 ]; then
 ...
 steps/nnet3/chain/train.py --stage $train_stage \
    --cmd "$train_cmd --mem 4G --h-rt 00:58:00" \

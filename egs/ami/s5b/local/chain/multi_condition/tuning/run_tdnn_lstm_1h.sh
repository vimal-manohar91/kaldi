...
# copied from non-multi_condition 1o
...
if [ $stage -le 15 ]; then
  ...
  lstm_opts="decay-time=40 l2-regularize=0.01 dropout-proportion=0.0"
  ...
  fast-lstmp-layer name=lstm4 cell-dim=1024 recurrent-projection-dim=256 non-recurrent-projection-dim=256 delay=-3 $lstm_opts

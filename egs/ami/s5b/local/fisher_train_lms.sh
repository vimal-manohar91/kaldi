...
text=~/workspace_chain_ts/egs/aspire/s5/data/train_all/text
lexicon=data/local/fisher_dict/lexicon.txt
...
cat $text | tr '[a-z]' '[A-Z]' | awk -v lex=$lexicon 'BEGIN{while((getline<lex) >0){ seen[$1]=1; } } 

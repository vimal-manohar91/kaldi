...
dir=data/local/tedlium_dict_nosp
mkdir -p $dir
...
( echo sil; echo laughter; echo noise; echo oov; ) > $dir/silence_phones.txt
...
echo '<unk> oov' | cat - $dir/lexicon_words.txt | sort | uniq > $dir/lexicon.txt

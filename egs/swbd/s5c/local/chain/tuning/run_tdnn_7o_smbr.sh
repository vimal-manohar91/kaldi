...
get_egs_stage=-10
speed_perturb=true
affix=7o_smbr0.2_mmi0.8
suffix=
$speed_perturb && suffix=_sp
if [ -e data/rt03 ]; then maybe_rt03=rt03; else maybe_rt03= ; fi

relu_dim=1280  # 1600
relu_dim_large=1536   # 1920
bottleneck_dim=256  # 320
...
smbr_factor_schedule="output=0.2,0.2"
mmi_factor_schedule="output=0.8,0.8"
...
if [ $stage -le 12 ]; then
  ...
  relu-batchnorm-dropout-layer name=tdnn1 $opts dim=$relu_dim
  ...
  relu-batchnorm-dropout-layer name=tdnn2 $opts input=Append(0,1) dim=$relu_dim
  linear-component name=tdnn3l dim=$bottleneck_dim $linear_opts input=Append(-1,0)
  relu-batchnorm-dropout-layer name=tdnn3 $opts dim=$relu_dim input=Append(0,1)
  ...
  relu-batchnorm-dropout-layer name=tdnn4 $opts input=Append(0,1) dim=$relu_dim
  linear-component name=tdnn5l dim=$bottleneck_dim $linear_opts
  relu-batchnorm-dropout-layer name=tdnn5 $opts dim=$relu_dim input=Append(0, tdnn3l)
  ...
  relu-batchnorm-dropout-layer name=tdnn6 $opts input=Append(0,3) dim=$relu_dim_large
  ...
  relu-batchnorm-dropout-layer name=tdnn7 $opts input=Append(0,3,tdnn6l,tdnn4l,tdnn2l) dim=$relu_dim
  ...
  relu-batchnorm-dropout-layer name=tdnn8 $opts input=Append(0,3) dim=$relu_dim_large
  ...
  relu-batchnorm-dropout-layer name=tdnn9 $opts input=Append(0,3,tdnn8l,tdnn6l,tdnn5l) dim=$relu_dim
  ...
  relu-batchnorm-dropout-layer name=tdnn10 $opts input=Append(0,3) dim=$relu_dim_large
  ...
  relu-batchnorm-dropout-layer name=tdnn11 $opts input=Append(0,3,tdnn10l,tdnn9l,tdnn7l) dim=$relu_dim
  linear-component name=prefinal-l dim=$bottleneck_dim $linear_opts

  relu-batchnorm-layer name=prefinal-chain input=prefinal-l $opts dim=$relu_dim_large
  ...
  relu-batchnorm-layer name=prefinal-xent input=prefinal-l $opts dim=$relu_dim_large

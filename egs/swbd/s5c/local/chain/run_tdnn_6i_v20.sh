...
if $use_ivector; then
  egs_dir="--egs-dir exp/chain/tdnn_6i_v4$suffix/egs"
else
  egs_dir="--egs-dir exp/chain/tdnn_6i_v20$suffix/egs"
fi

ivector_opts=""
if $use_ivector; then
  ivector_opts="--ivector-output-dim 500 --add-ivector-layer 3 --add-log-stddev $add_log_stddev" 
  ivector_feats="--online-ivector-dir exp/nnet3/ivectors_${train_set}"
fi

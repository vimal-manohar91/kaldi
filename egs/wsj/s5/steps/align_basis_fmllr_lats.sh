...
if [ $# != 4 ]; then
   echo "usage: steps/align_basis_fmllr_lats.sh <data-dir> <lang-dir> <src-dir> <align-dir>"
   echo "e.g.:  steps/align_basis_fmllr_lats.sh data/train data/lang exp/tri1 exp/tri1_lats"
...
if [ $stage -le 0 ]; then
  ...
  $cmd JOB=1:$nj $dir/log/compile_graphs.JOB.log  \
    $prog --read-disambig-syms=$lang/phones/disambig.int $scale_opts $dir/tree $dir/final.mdl  $lang/L.fst "$tra" \

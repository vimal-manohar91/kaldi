...
if __name__ == "__main__":
    ...
    nodes.AddOutputLayer(init_config_lines, prev_layer_output, label_delay = args.label_delay, objective_type = args.objective_type)
    ...
    for i in range(args.num_lstm_layers):
        ...
        if not add_final_sigmoid:
            nodes.AddFinalLayer(config_lines, prev_layer_output, args.num_targets, ng_affine_options = args.ng_affine_options, label_delay = args.label_delay, include_log_softmax = include_log_softmax, objective_type = args.objective_type)
        else:
            nodes.AddFinalSigmoidLayer(config_lines, prev_layer_output, args.num_targets, ng_affine_options = args.ng_affine_options, label_delay = args.label_delay, objective_type = args.objective_type)

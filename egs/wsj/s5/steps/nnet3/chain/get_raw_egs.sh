...
for f in $data/$wav_input $latdir/lat.1.gz $latdir/final.mdl \
...
if [ $stage -le 3 ]; then
  ...
  $cmd $dir/log/create_valid_subset.log \
    ...
    chain-get-supervision $ctc_supervision_all_opts $chaindir/tree $chaindir/0.trans_mdl \
      ark:- ark:- \| \
    nnet3-chain-get-raw-egs $valid_ivector_opt $valid_egs_opts $chaindir/normalization.fst \
  ...
  $cmd $dir/log/create_train_subset.log \
    ...
    nnet3-chain-get-raw-egs $train_subset_ivector_opt $valid_egs_opts $chaindir/normalization.fst \
...
if [ $stage -le 4 ]; then
  ...
  $cmd JOB=1:$nj $dir/log/get_egs.JOB.log \
    ...
    chain-get-supervision $ctc_supervision_all_opts \
      $chaindir/tree $chaindir/0.trans_mdl ark:- ark:- \| \
    nnet3-chain-get-raw-egs $ivector_opt $egs_opts \
     "$feats" ark,s,cs:- ark:- \| \

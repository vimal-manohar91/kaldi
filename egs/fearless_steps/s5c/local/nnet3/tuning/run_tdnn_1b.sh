...
if [ $stage -le 8 ]; then
  ...
  relu-renorm-layer name=tdnn1 input=Append(-1,0,1) dim=328
  relu-renorm-layer name=tdnn2 input=Append(-1,0,1) dim=328
  relu-renorm-layer name=tdnn3 input=Append(-1,0,1) dim=328
  relu-renorm-layer name=tdnn4 input=Append(-1,0,1) dim=328
  relu-renorm-layer name=tdnn5 input=Append(-1,0,1) dim=328
  relu-renorm-layer name=tdnn6 dim=328

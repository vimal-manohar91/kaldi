...
if [ $stage -le 16 ]; then
  ...
  lstm_opts="l2-regularize=0.000125 decay-time=20"
  final_lstm_opts="l2-regularize=0.00006125 decay-time=20"
  ...
  fast-lstmp-layer name=lstm5 cell-dim=$cell_dim recurrent-projection-dim=$projection_dim non-recurrent-projection-dim=$projection_dim delay=-3 dropout-proportion=0.0 $final_lstm_opts

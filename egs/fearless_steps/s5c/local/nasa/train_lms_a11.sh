...
extra_transcripts="data/local/nasa/spacelog_transcripts.txt data/local/nasa/apollo_html_reports.txt data/local/nasa/a11_html_reports.txt data/local/nasa/alsj_transcripts.txt data/local/nasa/alsj_a11_transcripts.txt"
dev_text=data/dev/text
dir=data/local/pocolm_nasa_a11
lang=data/lang
stage=-1

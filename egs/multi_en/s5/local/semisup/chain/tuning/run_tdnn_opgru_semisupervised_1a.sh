...
dir=$exp_root/chain${chain_affix}/tdnn_opgru${tdnn_affix}
...
if [ $stage -le 11 ]; then
  ...
  norm-opgru-layer name=opgru1 cell-dim=$hidden_dim recurrent-projection-dim=$projection_dim non-recurrent-projection-dim=$projection_dim delay=-3 $gru_opts
  ...
  norm-opgru-layer name=opgru2 cell-dim=$hidden_dim recurrent-projection-dim=$projection_dim non-recurrent-projection-dim=$projection_dim delay=-3 $gru_opts
  ...
  norm-opgru-layer name=opgru3 cell-dim=$hidden_dim recurrent-projection-dim=$projection_dim non-recurrent-projection-dim=$projection_dim delay=-3 $gru_opts

...
multi=multi_a
gmm=tri5a
dir=exp/multi_a/chain/tdnn_opgru_smbr0.2_1a # Note: _sp will get added to this if $speed_perturb == true.
decode_iter=
decode_dir_affix=
...
smbr_extra_opts="--one-silence-class true"
...
if [ $stage -le 13 ]; then
  ...
  steps/nnet3/chain/train.py --stage $train_stage \
    ...
    --chain.smbr-factor-schedule="$mmi_factor_schedule" \
    --chain.smbr-extra-opts "$smbr_extra_opts" \

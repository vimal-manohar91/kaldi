...
decode_opts="--extra-left-context 70 --extra-right-context 0 --frames-per-chunk 150 --extra-left-context-initial 0 --extra-right-context-final 0"
sad_nnet_dir=exp/segmentation_1a/tdnn_lstm_asr_sad_1a
...
steps/segmentation/detect_speech_activity.sh \
  ...
  $unseg_dir \
  $sad_nnet_dir mfcc_hires_bp \
  $sad_nnet_dir $sad_nnet_dir/${dataset_id}

utils/copy_data_dir.sh $sad_nnet_dir/${dataset_id}_seg $dataset_dir

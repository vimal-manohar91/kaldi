...
# This script is expected to be run after stage 8 of run_15k.sh.
...
if [ $stage -le 2 ]; then
  local/semisup/chain/tuning/run_tdnn_lstm_50k_semisupervised_1a.sh \
    ...
    --sup-chain-dir $exp_root/chain_semi15k_100k_250k/tdnn_lstm_1a_sp \
    --sup-lat-dir $exp_root/chain_semi15k_100k_250k/tri4a_train_sup15k_sp_unk_lats \

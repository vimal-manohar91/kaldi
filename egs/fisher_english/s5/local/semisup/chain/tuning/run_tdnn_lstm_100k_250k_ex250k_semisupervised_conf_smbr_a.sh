...
comb_affix=comb_250k_ex250k_1e_smbr  # affix for new chain-model directory trained on the combined supervised+unsupervised subsets
supervision_weights=1.0,1.0
train_extra_opts="--chain.mmi-factor-schedule=1.0,1.0@0.2,0.5@0.2,0.5 --chain.smbr-factor-schedule=0.0,0.0@0.2,0.2@0.2,0.2"
...
if [ $stage -le 15 ]; then
  steps/nnet3/chain/train.py --stage $train_stage \
    ...
    $train_extra_opts --chain.smbr-extra-opts="$chain_smbr_extra_opts" \

...
tdnn_affix=_semisup_1d  # affix for semi-supervised chain system
...
# Input seed system
sup_chain_dir=exp/semisup_100k/chain/tdnn_lstm_1d_sp  # supervised chain system
sup_lat_dir=exp/semisup_100k/chain/tri4a_train_sup_lats  # Seed model options
sup_tree_dir=exp/semisup_100k/chain/tree_bi_c  # tree directory for supervised chain system
...
unsup_decode_lang=data/lang_test_poco_sup100k

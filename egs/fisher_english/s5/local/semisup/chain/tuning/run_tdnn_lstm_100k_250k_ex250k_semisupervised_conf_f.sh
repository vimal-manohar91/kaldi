...
comb_affix=comb_250k_ex250k_1f  # affix for new chain-model directory trained on the combined supervised+unsupervised subsets
...
if [ $stage -le 15 ]; then
  steps/nnet3/chain/train.py --stage $train_stage \
    ...
    --chain.smbr-leaky-hmm-coefficient 0.00001 \
    --chain.mmi-factor-schedule="output-0=1.0,1.0 output-1=1.0,1.0" \
    --chain.smbr-factor-schedule="output-0=0.0,0.0 output-1=0.0,0.0" \

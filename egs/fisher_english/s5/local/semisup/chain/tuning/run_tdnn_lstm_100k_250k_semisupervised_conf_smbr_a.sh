...
comb_affix=comb_250k_1b_smbr  # affix for new chain-model directory trained on the combined supervised+unsupervised subsets
...
if [ $stage -le 15 ]; then
  steps/nnet3/chain/train.py --stage $train_stage \
    ...
    --chain.mmi-factor-schedule="output-0=1.0,1.0 output-1=0.5,0.5" \
    --chain.smbr-factor-schedule="output-0=0.0,0.0 output-1=0.2,0.2" \

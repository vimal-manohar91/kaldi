...
lat_dir=$exp/chain${chain_affix}/$(basename $gmm_dir)_${base_train_set}_sp_unk_lats  # training lattices directory
...
if [ $stage -le 13 ]; then
  ...
  steps/nnet3/chain/train.py --stage $train_stage \
    ...
    --combine-queue-opt "--h-rt 00:40:00" \

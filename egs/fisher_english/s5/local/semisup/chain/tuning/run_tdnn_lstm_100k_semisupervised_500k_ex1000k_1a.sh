...
tdnn_affix=_semisup100k_250k_ex1000k_1a  # affix for semi-supervised chain system
...
if [ $stage -le 5 ]; then
  ...
  steps/nnet3/decode_semisup.sh --num-threads $num_threads --nj $nj --cmd "$decode_cmd" \

...
tdnn_affix=_semisup_1b2  # affix for semi-supervised chain system
...
if [ $stage -le 11 ]; then
  ...
  lstm_opts="l2-regularize=0.000625 decay-time=20"
  lstm_final_opts="l2-regularize=0.00125 decay-time=20"

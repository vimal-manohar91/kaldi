...
if [ $stage -le 10 ]; then
  ...
  steps/align_fmllr_lats.sh --nj $nj --cmd "$train_cmd --h-rt 40:00:00" \
...
if [ $stage -le 13 ]; then
  ...
  tdnn_opts="l2-regularize=0.003125"
  lstm_opts="l2-regularize=0.00125 decay-time=20"
  lstm_final_opts="l2-regularize=0.0025 decay-time=20"

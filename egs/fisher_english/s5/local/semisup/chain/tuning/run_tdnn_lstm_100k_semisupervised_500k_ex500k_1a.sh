...
tdnn_affix=_semisup100k_500k_ex500k_1a  # affix for semi-supervised chain system
...
lm_weights=2,1  # Weights on phone counts from supervised, unsupervised data for denominator FST creation

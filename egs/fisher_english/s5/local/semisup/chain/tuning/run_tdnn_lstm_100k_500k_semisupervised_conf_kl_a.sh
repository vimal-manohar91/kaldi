...
mmi_factor_schedule="output-0=1.0,1.0 output-1=0.5,0.5"
kl_factor_schedule="output-0=0.0,0.0 output-1=0.5,0.5"

# Semi-supervised options
comb_affix=comb_500k_1a_kl0.5  # affix for new chain-model directory trained on the combined supervised+unsupervised subsets

...
if [ $stage -le 13 ]; then
  ...
  tdnn_opts="l2-regularize=0.0015625"
  lstm_opts="ng-affine-options=\"max-change=1.5 l2-regularize=0.0006125\" lstm-nonlinearity-options=\"max-change=0.75 l2-regularize=0.00030625\" decay-time=20"
  lstm_final_opts="ng-affine-options=\"max-change=1.5 l2-regularize=0.00125\" lstm-nonlinearity-options=\"max-change=0.75 l2-regularize=0.0006125\" decay-time=20"

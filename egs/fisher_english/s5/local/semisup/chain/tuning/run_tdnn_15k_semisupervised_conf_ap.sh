...
# This script is same as _ao, but uses creates denominator FST using speed-perturbed data.
...
comb_affix=comb1ap  # affix for new chain-model directory trained on the combined supervised+unsupervised subsets

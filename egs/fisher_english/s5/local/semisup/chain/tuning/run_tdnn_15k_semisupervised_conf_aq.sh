...
# This script is same as _ao, but uses smaller weight on supervised phone alignments
# because they are from speed perturbed data.
# sup_frames_per_eg=160,140,110,80
# unsup_frames_per_eg=150
# Deriv weights: Lattice posterior of best path pdf
# Unsupervised weight: 1.0
# Weights for phone LM (supervised, unsupervises): 5,6
...
comb_affix=comb1aq  # affix for new chain-model directory trained on the combined supervised+unsupervised subsets
